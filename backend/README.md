...
- make linters
## Alembic Migrations
- Initialize Alembic (for new projects only): make init-alembic
...
1)CLASSIC_MAT_BALANCE - классический мат баланс "по учебнику" - абсолютно не подходит для месторождений ИНК
2)EXCEL_MAT_BALANCE - копия расчётов в Экселе с улучшенным методом поиска корней функции мат баланса. Рабочая 
версия расчёта мат баланса ячейки
